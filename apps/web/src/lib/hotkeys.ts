...
export const HOTKEY_ACTIONS: readonly HotkeyActionMeta[] = [
  ...
  { id: "ungroup", label: "Ungroup", description: "Ungroup the selected group.", category: "Transform" },
  ...
  { id: "chamfer", label: "Chamfer", description: "Start or cancel chamfer.", category: "Tools" },
  { id: "fillet", label: "Fillet", description: "Start or cancel fillet.", category: "Tools" },
